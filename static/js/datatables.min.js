 ...
 *   https://datatables.net/download/#dt/jq-3.2.1/jq-3.2.1/dt-1.10.16/b-1.4.2/b-html5-1.4.2/fh-3.1.3/r-2.2.0/sc-1.4.3
 *
 * Included libraries:
 *   jQuery 3 3.2.1, jQuery 3 3.2.1, DataTables 1.10.16, Buttons 1.4.2, HTML5 export 1.4.2, FixedHeader 3.1.3, Responsive 2.2.0, Scroller 1.4.3
 */
...
(function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, G) { E || (E = window);
    ...
    function Y(a) { if (!1 !== a.oFeatures.bAutoWidth) { var b = a.aoColumns;
            Ea(a); for (var c = 0, d = b.length; c < d; c++) b[c].nTh.style.width = b[c].sWidth } b = a.oScroll;
        ("" !== b.sY || "" !== b.sX) && ka(a);
        ...
        if (-1 !== h.inArray(!1, b)) C(a, !1);
            ...
            if (0 !== i.length) { f = j ? a.aoData.length : n; for (j = j ? 0 : g; j < f; j++) { var l = i[j],
                    ...
                    l = q.nTr; if (0 !== e) { var t = d[c % e];
                        q._sRowStripe != t && (h(l).removeClass(q._sRowStripe).addClass(t), q._sRowStripe = t) } r(a, "aoRowCallback", null, [l, q._aData, c, j]);
                    b.push(l);
            ...
            b = function(b) {
                if (b && b.time) {
                    ...
                    if (-1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && b.time < +new Date - 1E3 * g) && !(b.columns && f.length !== b.columns.length))) {
                        ...
                        if (b.columns) { d = 0; for (e = b.columns.length; d < e; d++) g = b.columns[d], g.visible !== k && (f[d].bVisible = g.visible), g.search !== k && h.extend(a.aoPreSearchCols[d], Ab(g.search)) } r(a, "aoStateLoaded", "stateLoaded", [a, b])
                    }
                }
                c()
            };
    ...
    var Za = function(a, b, c, d, e) {
            ...
            for (n = b.length; i < n; i++) { j = b[i] && b[i].split && !b[i].match(/[\[\(:]/) ? b[i].split(",") : [b[i]];
                l = 0; for (m = j.length; l < m; l++)(g = c("string" === typeof j[l] ? h.trim(j[l]) : j[l])) && g.length && (f = f.concat(g)) } a = x.selector[a];
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfoFiltered: "(de _MAX_ entradas totales)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    m.ext = x = {
        buttons: {},
        classes: {},
        build: "dt/jq-3.2.1/jq-3.2.1/dt-1.10.16/b-1.4.2/b-html5-1.4.2/fh-3.1.3/r-2.2.0/sc-1.4.3",
        errMode: "alert",
        feature: [],
        search: [],
        ...
        pageButton: {
            _: function(a, b, c, d, e, f) {
                var g = a.oClasses,
                    ...
                    s;
                try { s = h(b).find(G.activeElement).data("dt-idx") } catch (u) {} o(h(b).empty(), d);
...
(function(d) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(n) { return d(n, window, document) }) : "object" === typeof exports ? module.exports = function(n, o) { n || (n = window); if (!o || !o.fn.dataTable) o = require("datatables.net")(n, o).$; return d(o, n, n.document) } : d(jQuery, window, document) })(function(d, n, o, l) {
    ...
    d.extend(m.prototype, {
        ...
        add: function(a, b) { var c = this.s.buttons; if ("string" === typeof b) { for (var e = b.split("-"), c = this.s, d = 0, h = e.length - 1; d < h; d++) c = c.buttons[1 * e[d]];
                c = c.buttons;
                b = 1 * e[e.length - 1] } this._expandButton(c, a, !1, b);
        ...
        _expandButton: function(a, b, c, e) {
            for (var g = this.s.dt, h = 0,
                    ...
                    if (d.isArray(k)) this._expandButton(a, k, c, e);
                                ...
                                this._expandButton(p.buttons, p.conf.buttons, !0, e) } k.init && k.init.call(g.button(p.node), g, d(p.node), k);
                            h++ } } }
        },
        ...
        _resolveExtends: function(a) {
            for (var b = this.s.dt, c, e, g = function(c) { for (var e = 0; !d.isPlainObject(c) && !d.isArray(c);) { if (c === l) return; if ("function" === typeof c) { if (c = c(b, a), !c) return !1 } else if ("string" === typeof c) { if (!j[c]) throw "Unknown button type: " + c;
                            c = j[c] } e++; if (30 < e) throw "Buttons: Too many iterations"; } return d.isArray(c) ? c : d.extend({}, c) }, a = g(a); a && a.extend;) {
            ...
            if (j.isPlainObject(b)) { var e = a.folder(c);
                ...
                if (u) {
                    var e = b.childNodes[0],
                        f, g, n = [];
                    for (f = e.attributes.length - 1; 0 <= f; f--) { g = e.attributes[f].nodeName; var h = e.attributes[f].nodeValue; - 1 !== g.indexOf(":") && (n.push({ name: g, value: h }), e.removeAttribute(g)) } f = 0;
            ...
            if (l.queryCommandSupported("copy")) { d.appendTo(c.table().container());
                ...
                b[0].select(); try { var h = l.execCommand("copy");
                    d.remove(); if (h) { c.buttons.info(c.i18n("buttons.copyTitle", "Copy to clipboard"), c.i18n("buttons.copySuccess", { 1: "Copied one row to clipboard", _: "Copied %d rows to clipboard" }, a.rows), 2E3);
                        this.processing(!1); return } } catch (k) {} } h = j("<span>" + c.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") +
                "</span>").append(d);
    ...
    e.extend(h.prototype, {
        ...
        _fnInfo: function() {
            if (this.s.dt.oFeatures.bInfo) {
                ...
                d = a.aanFeatures.i;
                if ("undefined" != typeof d) { f = 0; for (i = d.length; f < i; f++) e(d[f]).html(g) } e(a.nTable).triggerHandler("info.dt")
            }
        }
    });
    h.defaults = {
